        ...
        <div class="talent-list bt-flex-scroller">
            ...
            >
                <van-cell is-link v-for="t in talentList" :key="t.id" :to="`/talentdetail/${t.address}`">
                    ...
                    <div slot="title">
                        <p>发布任务<span class="t-warning">1</span>次 已被解决<span class="t-primary">1</span>次</p>
                        <p>提交方案<span class="t-warning">2</span>次 已被接受<span class="t-primary">{{t.solved}}</span>次</p>
                        <p>发布问题<span class="t-warning">1000</span>次 回答问题<span class="t-primary">99</span>次</p>
