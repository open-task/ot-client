    ...
    export default {
        ...
        methods: {
            ...
            get_question_detail: function() {
                ...
                self.$http.post('/skill/get_question', {
                    question_id: q_id
                }).then(function(re) {
                    console.log('获取详情', re)
            ...
            get_questions: function() {
                //获取问题列表
                let self = this
                self.$http.post('/skill/get_question_list', {}).then(function(re) {
            ...
            publish_answer: async function() {
                ...
                //以上为提交服务器的参数
                self.$http.post('/skill/answer', info).then(function(re) {
            ...
            publish_question: async function() {
                ...
                self.$http.post("/skill/new_question", info).then(function(re) {
